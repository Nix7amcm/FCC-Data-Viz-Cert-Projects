// Treemap Diagram: Video Game Sales
// Top 100 Most Sold Video Games Grouped by Platform

// Dataset: https://cdn.freecodecamp.org/testable-projects-fcc/data/tree_map/video-game-sales-data.json
// Data Format:
/* {
...
//### FETCH THE DATA ###
//>>> Fetch the video game sales data
...
//### CREATE THE TREEMAP ###
function createTreemap ( videoGameData ) {
  ...
  const rootHierarchy = d3.hierarchy( videoGameData )
  ...
  const categories = videoGameData.children.map( d => d.name );
