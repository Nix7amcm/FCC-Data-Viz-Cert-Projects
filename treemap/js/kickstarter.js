// Treemap Diagram: Kickstarter Pledges
// Top 100 Most Pledged Kickstarter Campaigns Grouped By Category

// Dataset: https://cdn.freecodecamp.org/testable-projects-fcc/data/tree_map/kickstarter-funding-data.json
// Data Format:
/* {
  "name": "Kickstarter",
  "children": [
...
//### CREATE THE TREEMAP ###
function createTreemap ( kickstarterData ) {
  ...
  const rootHierarchy = d3.hierarchy( kickstarterData )
  ...
  const categories = kickstarterData.children.map( d => d.name );
